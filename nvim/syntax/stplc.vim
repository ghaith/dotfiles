...
syn keyword stplcConditional if else then elseif end_if case end_case while for end_while end_for begin
syn keyword stplcStatement function end_function function_block end_function_block var end_var var_input var_output var_in_out var_config program end_program
